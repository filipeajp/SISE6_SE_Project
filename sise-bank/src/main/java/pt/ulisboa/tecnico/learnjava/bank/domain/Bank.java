...
public class Bank {
	...
	public static void main(String[] args) throws BankException, AccountException, ClientException {
		...
		Person personOne = new Person("José", "Manuel", "987654321", "Street", 34);
		Client clientOne = new Client(cgd, personOne, "123456789");
		Person personTwo = new Person("José", "Manuel", "987654321", "Street", 34);
		Client clientTwo = new Client(cgd, personTwo, "123456789");
