...
public class MBWayInterface {
	...
	public static void main(String[] args) throws SibsException, AccountException, OperationException, BankException,
		...
		Client clientTwo = new Client(cgd, "Joseph", "Manuel", "123456789", "987654321", "Second Street", 34);
		Client clientThree = new Client(cgd, "Joseph", "Manuel", "123456782", "987654321", "Second Street", 34);
		Client clientFour = new Client(cgd, "Joseph", "Manuel", "123456783", "987654321", "Second Street", 34);
		Client clientFive = new Client(cgd, "Joseph", "Manuel", "123456784", "987654321", "Second Street", 34);
		Client clientSix = new Client(cgd, "Joseph", "Manuel", "123456785", "987654321", "Second Street", 34);
		Client clientSeven = new Client(cgd, "Joseph", "Manuel", "123456786", "987654321", "Second Street", 34);
		Client clientEight = new Client(cgd, "Joseph", "Manuel", "123456787", "987654321", "Second Street", 34);
		Client clientNine = new Client(cgd, "Joseph", "Manuel", "123456788", "987654321", "Second Street", 34);
		Client clientTen = new Client(cgd, "Joseph", "Manuel", "123556789", "987654321", "Second Street", 34);
		...
		// passar sibs/services para controller
